...
- [ ] each codex starts a fresh session in inner loop. should re-use existing session by resuming the previous session instead. should use best practices mentioned in https://x.com/trq212/status/2024574133011673516?s=20 (please create research doc on prompt caching based on this article first)
